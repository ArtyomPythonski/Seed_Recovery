...
def create_tab1(notebook):
    ...
    # Instructions
    main_description = tk.Label(instruction_frame,bg="#F2F2F2",fg="#0081C9",text='Enter the seed phrase marking with "???" the unknown words', font=("Arial", 13) )
    ...
    var = IntVar()
    checkbox_address = tk.Checkbutton(instruction_frame, bg="#F2F2F2", fg="#0081C9", activebackground="#F2F2F2", activeforeground="#0081C9", highlightthickness=0, text="Whole Adress\Partial Address", variable=var, command=Checked, onvalue=1, offvalue=0, border=None)
